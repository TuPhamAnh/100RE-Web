...
export const SEED_TASKS = [
  ...
  { id: 'tsk-03', team_id: 'team-pv', project_id: 'proj-pv-01', experiment_id: 'exp-pv-01', title: 'Deploy Spatio-temporal Transformer for 15-min Solar Forecasting', description: 'Train Vision Transformer with Sky Imager footage and Pyranometer irradiance log to predict sudden cloud ramp events.', status: 'in_progress', priority: 'high', assigned_to: 'usr-res-01', created_by: 'usr-ldr-01', due_date: '2026-09-20', created_at: 1707300000, updated_at: 1708600000, completed_at: null },
  { id: 'tsk-04', team_id: 'team-smartgrid', project_id: 'proj-grid-01', experiment_id: 'exp-grid-01', title: 'Build Microgrid Opal-RT Model with High PV & BESS Penetration', slug: 'build-opal-rt-microgrid', description: 'Simulate islanding transition and black start capability with Grid-Forming inverters in OPAL-RT FPGA chassis.', status: 'planning', priority: 'medium', assigned_to: 'usr-res-02', created_by: 'usr-sup-01', due_date: '2026-10-01', created_at: 1709300000, updated_at: 1709300000, completed_at: null },
  { id: 'tsk-05', team_id: 'team-pv', project_id: 'proj-pv-01', experiment_id: 'exp-pv-01', title: 'Calibrate C7 Rooftop Total Sky Imager HDR Fisheye Lens', description: 'Calibrate geometric distortion matrix and cloud classification algorithm for hemispherical sky imager.', status: 'done', priority: 'medium', assigned_to: 'usr-res-01', created_by: 'usr-ldr-01', due_date: '2026-08-20', created_at: 1706500000, updated_at: 1708400000, completed_at: 1708400000 }
];
