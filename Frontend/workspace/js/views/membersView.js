  ...
  try {
    ...
    if (!users || users.length === 0) {
      users = [
        ...
        { id: 'usr-ldr-01', username: 'duc.ngotri@100relab', display_name: 'Dr. Ngo Tri Duc', name: 'Dr. Ngo Tri Duc', email: 'duc.ngotri@100relab', role: 'team_leader', status: 'active', teams: [{ team_id: 'team-pv', team_name: 'Photovoltaic (PV)' }], member_key: 'pv-1', permissions: [] },
        { id: 'usr-ldr-02', username: 'phuong.trinhminh@100relab', display_name: 'Dr. Trinh Minh Phuong', name: 'Dr. Trinh Minh Phuong', email: 'phuong.trinhminh@100relab', role: 'team_leader', status: 'active', teams: [{ team_id: 'team-bess', team_name: 'Battery Storage (BESS)' }], member_key: 'bess-1', permissions: [] },
        { id: 'usr-res-05', username: 'hai.duongminh@100relab', display_name: 'Duong Minh Hai', name: 'Duong Minh Hai', email: 'hai.duongminh@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-smartgrid', team_name: 'Smart Grid' }], member_key: 'smartgrid-2', permissions: [] },
        { id: 'usr-res-01', username: 'hai.buiquang@100relab', display_name: 'Bui Quang Hai', name: 'Bui Quang Hai', email: 'hai.buiquang@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-ai', team_name: 'Artificial Intelligence (AI)' }], member_key: 'ai-1', permissions: [] },
        { id: 'usr-res-02', username: 'anh.nguyentuan@100relab', display_name: 'Nguyen Tuan Anh', name: 'Nguyen Tuan Anh', email: 'anh.nguyentuan@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-smartgrid', team_name: 'Smart Grid' }], member_key: 'dr_uc-1', permissions: [] },
        { id: 'usr-res-03', username: 'nam.nguyenhoang@100relab', display_name: 'Nguyen Hoang Nam', name: 'Nguyen Hoang Nam', email: 'nam.nguyenhoang@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-wind', team_name: 'Wind Energy' }], member_key: 'wind-1', permissions: [] },
        { id: 'usr-res-04', username: 'cuong.lethe@100relab', display_name: 'Le The Cuong', name: 'Le The Cuong', email: 'cuong.lethe@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-ev', team_name: 'Electric Vehicle (EV)' }], member_key: 'ev-1', permissions: [] },
        { id: 'usr-res-06', username: 'dung.vutien@100relab', display_name: 'Vu Tien Dung', name: 'Vu Tien Dung', email: 'dung.vutien@100relab', role: 'researcher', status: 'active', teams: [{ team_id: 'team-smartgrid', team_name: 'Smart Grid' }], member_key: 'smartgrid-3', permissions: [] }
      ];
    }
